...
class Plugin(PluginInterface):
    ...
    def get_default_config(self):
        return {"build_url_environment_variable": "BUILD_URL", "link_template": "%(build_url)s/artifact/%(log_path)s"}
    ...
    def _get_build_url(self):
        ...
        """
        retval = os.environ.get(self.current_config.build_url_environment_variable)
    ...
    def test_end(self):
        ...
        if build_url is not None:
            ...
            context.result.details.set(
                ...
                % {"build_url": build_url, "log_path": "/".join(local_path.split(os.sep))},
            )

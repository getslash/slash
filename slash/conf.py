...
config = Config({
    ...
    "log": {
        ...
        "errors_subpath": None // Doc("Depreacted - Use 'hightlights_subpath' config instead"),
        "hightlights_subpath": None // Doc("If set, this path will be used to record highlights (eg. errors added) in the session and/or tests"),

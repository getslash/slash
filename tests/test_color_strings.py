...
class ColoredStringTest(TestCase):
    def test_colored_string(self):
        ...
        self.assertEqual(colored.get_colored(), colorama.Fore.RED + orig + colorama.Fore.RESET)

    def test_get_formatter(self):
        f = ColorString.get_formatter("red")
        self.assert_colored(f("test"), colorama.Fore.RED + "test" + colorama.Fore.RESET, "test")
    ...
    def test_formatting(self):
        ...
        self.assert_colored(colored_formatted, colorama.Fore.RED + orig_formatted + colorama.Fore.RESET, orig_formatted)
    ...
    def test_concatenation_postfix(self):
        self.assert_colored(
            ColorString("a", color="red") + "b", colorama.Fore.RED + "a" + colorama.Fore.RESET + "b", "ab"
        )

    def test_concatenation_prefix(self):
        self.assert_colored(
            "a" + ColorString("b", color="red"), "a" + colorama.Fore.RED + "b" + colorama.Fore.RESET, "ab"
        )

    def test_complex_concatenation(self):
        self.assert_colored(
            "this is " + ColorString("a message", color="red") + " to be colored",
            "this is " + colorama.Fore.RED + "a message" + colorama.Fore.RESET + " to be colored",

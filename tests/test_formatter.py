...
class FormatterTest(TestCase):
    ...
    def test__write_non_strings(self):
    ...
    def test__write_writeln(self):
        self.f.writeln("hello")
        self.assertOutput("hello\n")
        self.f.write("a")
        self.f.write("bcd")
        self.assertOutput("hello\nabcd")
    def test__empty_writeln(self):
        self.f.writeln('a')
        self.f.writeln()
        self.f.writeln()
        self.f.writeln('b')
        self.assertOutput('a\n\n\nb\n')
    def test__multiline_write(self):
        self.f.writeln('a\nb')
        with self.f.indented(3, string='.'):
            self.f.writeln('c\n d\ne')
        self.f.writeln('f')
        self.assertOutput("a\nb\n...c\n... d\n...e\nf\n")
    def test__indentation(self):
    ...
    def test__indentation_different_char_through_ctor(self):
        self._test__indentation_different_char(True)
    def test__indentation_different_char_not_through_ctor(self):

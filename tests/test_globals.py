...
def test_current_test():
    ...
    suite.add_test(type="method").prepend_line("assert slash.test == self")
    suite.add_test(type="method").prepend_line("assert slash.context.test == self")
    suite.add_test(type="method").prepend_line("assert slash.context.test.__slash__.id == self.__slash__.id")
    suite.add_test(type="method").prepend_line("assert slash.context.test_id == self.id")
